...
const updatePassIndicator = () => {
    // if lengthSlider value is less than 8 then pass "weak" as passIndicator id 
    //else if lengthSlider value is less than 16 then pass "medium" as id else pass "strong" as id
...
const copyPassword = () => { 
    ...
    copyIcon.innerText = "check"; // changing copy icon to tick mark
    setTimeout( () => { // after 1500ms changing tick mark back to copy icon
